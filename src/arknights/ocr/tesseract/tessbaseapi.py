...
if libname:
    ...
    TessBaseAPIInit4 = cfunc(tesseract, 'TessBaseAPIInit4', ctypes.c_int, ctypes.c_void_p, ctypes.c_char_p,
                             ctypes.c_char_p, ctypes.c_int, ctypes.c_void_p, ctypes.c_int, ctypes.c_void_p,
                             ctypes.c_void_p, ctypes.c_size_t, ctypes.c_int)
    TessBaseAPISetImage = cfunc(tesseract, 'TessBaseAPISetImage', None, ctypes.c_void_p, ctypes.c_void_p, ctypes.c_int,
    ...
    TessBaseAPISetSourceResolution = cfunc(tesseract, 'TessBaseAPISetSourceResolution', None, ctypes.c_void_p,
                                           ctypes.c_int)
    TessBaseAPISetVariable = cfunc(tesseract, 'TessBaseAPISetVariable', ctypes.c_bool, ctypes.c_void_p, ctypes.c_char_p,
                                   ctypes.c_char_p)
...
class BaseAPI:
    def __init__(self, datapath, language, oem=TessOcrEngineMode.OEM_DEFAULT, configs=None, vars=None,
        ...
        if vars is not None:
            ...
            varnamearr = None
            varvaluearr = None
        result = TessBaseAPIInit4(self.baseapi, datapath, language.encode(), oem, configsarr, configlen, varnamearr,
                                  varvaluearr, varlen, set_only_non_debug_params)
        if result != 0:
...
if __name__ == '__main__':
    ...
    print(version)
    tess = BaseAPI(r"C:\Users\dant\AppData\Local\Tesseract-OCR\tessdata", 'chi_sim',
